...
import (
	...
	"github.com/hgg-6/pkgTool/v2/channelx/messageQueuex/saramax/saramaConsumerx/ConsumerGroupHandlerx"
	"github.com/hgg-6/pkgTool/v2/channelx/messageQueuex/saramax/saramaConsumerx/serviceLogic"
	"github.com/hgg-6/pkgTool/v2/channelx/messageQueuex/saramax/saramaProducerx"
...
func InitLog() logx.Loggerx {
	...
	return zerologx.NewZeroLogger(new(zerolog.New(os.Stderr).Level(zerolog.InfoLevel).With().Timestamp().Logger()))
}
