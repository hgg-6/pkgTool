...
//
//	mockgen -source=./types.go -package=BatchConsumerHandlermocks -destination=mocks/BatchConsumerHandler/mqX.BatchConsumerHandlermock.go mqX
//

// Package BatchConsumerHandlermocks is a generated GoMock package.
package BatchConsumerHandlermocks
