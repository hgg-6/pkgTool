...
import (
	...
	"github.com/hgg-6/pkgTool/v2/DBx/mysqlX/gormx/dbMovex/myMovex/messageQueue/consumerx"
	"github.com/hgg-6/pkgTool/v2/DBx/mysqlX/gormx/dbMovex/myMovex/scheduler"
	...
	"github.com/hgg-6/pkgTool/v2/webx/ginx"
...
func initLog() logx.Loggerx {
	...
	return zerologx.NewZeroLogger(new(zerolog.New(os.Stdout).Level(zerolog.DebugLevel).With().CallerWithSkipFrameCount(4).Timestamp().Logger()))
}
